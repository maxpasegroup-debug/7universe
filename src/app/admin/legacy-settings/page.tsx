...
/** Legacy `app_settings` table — fallback URLs if CMS is empty. Prefer configuring Steps + Materials. */
export default function AdminLegacySettingsPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6">
      <h1 className="font-display text-2xl font-bold text-slate-50">Legacy app settings</h1>
      <p className="mt-1 text-sm text-slate-500">
        Per-language video/PDF/join URLs in <code className="text-amber-200/80">app_settings</code>. Seed uses this to bootstrap the CMS.
      </p>
